package com.example.user.thetortoiseandthehare;
        ...
        public void handleMessage(Message msg) {
            ...
            if(rabbit_count>=100)
                if(tortoise_count<100)
                    Toast.makeText(MainActivity.this,"Hare Wins",Toast.LENGTH_LONG).show();
        }
    };
    ...
    private void runAsyncTask() {
        new AsyncTask<Void, Integer, Boolean>() {
            ...
            protected void onPostExecute(Boolean status) {
                if(rabbit_count<100)
                    Toast.makeText(MainActivity.this,"Tortoise Wins", Toast.LENGTH_LONG).show();
            }
        }.execute();
    }
}
